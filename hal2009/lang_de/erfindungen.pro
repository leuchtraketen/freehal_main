...
hat erfunden <> _benjamin_franklin_ <> den blitzableiter <>  <> (true)
hat erfunden <> _benjamin_franklin_ <> die bifokalbrille <>  <> (true)
...
hat erfunden <> _albert_hofmann_ <> das lsd <>  <> (true)
...
hat erfunden <> _arnold_william_arnold_anthony_ <> das galvanometer <>  <> (true)
...
hat erfunden <> _august_fischer_ <> den uhu <>  <> (true)
...
hat erfunden <> _bill_gates_ <> das windowsbetriebssystem <>  <> (true)
...
hat erfunden <> _dieter_binninger_ <> die ewigkeitsgluehbirne <>  <> (true)
...
hat erfunden <> _gottlieb_daimler_ <> den benzinmotor <>  <> (true)
hat erfunden <> gregory pincus <> die antibabypille <>  <> (true)
hat erfunden <> _guglielmo_marconi_ <> die drahtlose telegrafie <>  <> (true)
...
hat erfunden <> _hermann_oberth_ <> die feststoffraketen <>  <> (true)
...
hat erfunden <> _john_warner_backus_ <> fortran <>  <> (true)
...
hat erfunden <> _joseph_bramah_ <> die zapfanlage <>  <> (true)
hat erfunden <> _joseph_gayetty_ <> das klopapier <>  <> (true)
...
hat erfunden <> _louis_renault_ <> den stossdaempfer <>  <> (true)
...
hat erfunden <> _max_knoll_ <> das elektronenmikroskop <>  <> (true)
...
hat erfunden <> _reinhold_burger_ <> die thermosflasche <>  <> (true)
...
hat erfunden <> _thomas_adams_ <> den kaugummi erfunden <>  <> (true)
hat erfunden <> _titusz_ott_titusz_blthy_ <> das wattmeter <>  <> (true)
hat erfunden <> _titusz_ott_titusz_blthy_ <> den transformator <>  <> (true)
hat erfunden <> _titusz_ott_titusz_blthy_ <> den turbogenerator <>  <> (true)
...
entdeckte <> _frau_woehler_ <> das aluminium <> im jahr 1827 <> (true)
...
erfand <> _henry_bessemer_ <> den bessemerstahl <> im jahr 1856 <> (true)
...
erfand <> _james_watt_ <> die dampfmaschine <> im jahr 1765 <> (true)
...
erfand <> _alfred_nobel_ <> das dynamit <> im jahr 1867 <> (true)
...
erfand <> _otto_lilienthal_ <> das gleitflugzeug <> im jahr 1891 <> (true)
...
erfand <> _thomas_alva_edison_ <> das kinematoskop <> im jahr 1889 <> (true)
...
erfand <> _thomas_alva_edison_ <> das kohlemikrophon <> im jahr 1877 <> (true)
...
erfand <> _thomas_alva_edison_ <> den phonograph <> im jahr 1877 <> (true)
...
erdachte <> _albert_einstein_ <> die relativitaetstheorie <> im jahr 1913 <> (true)
...
entdeckte <> _robert_koch_ <> den tuberkelbazillus <> im jahr 1882 <> (true)
entdeckte <> _robert_koch_ <> das tuberkulin <> im jahr 1890 <> (true)
...
fand <> _robert_koch_ <>  <> den;im jahr 1878   wundinfektionserreger <> (true)
...
entdeckten <> _ernest_rutherford_ <> 190 die gammastrahlen <> im jahr <> (true)
...
erfand <> _hubert_cecil_booth_ <> den staubsauger <> im jahr 1902 <> (true)
