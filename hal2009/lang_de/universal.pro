...
ist <> aikido <> _eine_moderne_ <> _(japanische_kampfkunst_)_ <> <> (true)
...
ist <> die londoner oper <> <> _in_london_(dumme_frage_)_ <> <> (true)
...
singt <> ein saenger <> <> _(das_weiss_doch_jedes_kind_)_ <> <> (true)
