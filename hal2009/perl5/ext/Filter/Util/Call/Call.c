...
#endif
    if (items < 0 || items > 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Filter::Util::Call::filter_read", "size=0");
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Filter::Util::Call::real_import", "object, perlmodule, coderef");
    PERL_UNUSED_VAR(cv); /* -W */
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Filter::Util::Call::filter_del", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 240 "Call.xs"
        dMY_CXT;
