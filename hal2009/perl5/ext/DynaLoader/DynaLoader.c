...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DynaLoader::dl_load_file", "filename, flags=0");
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DynaLoader::dl_unload_file", "libref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DynaLoader::dl_find_symbol", "libhandle, symbolname");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DynaLoader::dl_undef_symbols", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 239 "DynaLoader.xs"
#line 311 "DynaLoader.c"
    }
    XSRETURN_EMPTY;
}
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "DynaLoader::dl_install_xsub", "perl_name, symref, filename=\"$Package\"");
    PERL_UNUSED_VAR(cv); /* -W */
    {
