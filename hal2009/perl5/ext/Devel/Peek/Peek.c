...
#endif
    if (items < 0 || items > 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::mstat", "str=\"Devel::Peek::mstat: \"");
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::fill_mstats", "sv, level= 0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	sv = ST(0);
	int	level;
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::mstats_fillhash", "sv, level= 0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	sv = ST(0);
	int	level;
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::mstats2hash", "sv, rv, level= 0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	sv = ST(0);
	SV *	rv = ST(1);
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::Dump", "sv, lim=4");
    PERL_UNUSED_VAR(cv); /* -W */
...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::DumpArray", "lim, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::DumpProg", "");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::SvREFCNT", "sv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	sv = ST(0);
	I32	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::SvREFCNT_inc", "sv");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::SvREFCNT_dec", "sv");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::DeadCode", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	RETVAL;
#line 411 "Peek.xs"
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::CvGV", "cv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	cv = ST(0);
	SV *	RETVAL;
...
#endif
    if (items < 0 || items > 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Devel::Peek::runops_debug", "flag= -1");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	bool	RETVAL;
	int	flag;
