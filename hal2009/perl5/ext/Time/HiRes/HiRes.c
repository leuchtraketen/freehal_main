...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::constant", "sv");
    PERL_UNUSED_VAR(cv); /* -W */
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::usleep", "useconds");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::nanosleep", "nsec");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::ualarm", "useconds, interval=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::alarm", "seconds, interval=0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::gettimeofday", "");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::time", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 980 "HiRes.xs"
        struct timeval Tp;
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::setitimer", "which, seconds, interval = 0");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::getitimer", "which");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items < 0 || items > 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::clock_gettime", "clock_id = CLOCK_REALTIME");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	clock_id;
#line 1084 "HiRes.xs"
...
#endif
    if (items < 0 || items > 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::clock_gettime", "clock_id = 0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	clock_id;
	NV	RETVAL;
...
#endif
    if (items < 0 || items > 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::clock_getres", "clock_id = CLOCK_REALTIME");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	clock_id;
#line 1114 "HiRes.xs"
...
#endif
    if (items < 0 || items > 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::clock_getres", "clock_id = 0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	clock_id;
	NV	RETVAL;
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::clock_nanosleep", "clock_id, nsec, flags = 0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::clock_nanosleep", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	NV	RETVAL;
	dXSTARG;
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::HiRes::clock", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1181 "HiRes.xs"
	clock_t clocks;
