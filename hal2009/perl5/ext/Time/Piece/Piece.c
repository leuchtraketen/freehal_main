...
#endif
    if (items < 7 || items > 10)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::Piece::_strftime", "fmt, sec, min, hour, mday, mon, year, wday = -1, yday = -1, isdst = -1");
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::Piece::_tzset", "");
    PERL_UNUSED_VAR(cv); /* -W */
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Time::Piece::_strptime", "string, format");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
XS(boot_Time__Piece)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("Time::Piece::_strftime", XS_Time__Piece__strftime, file, "$$$$$$$;$$$");
        newXSproto("Time::Piece::_tzset", XS_Time__Piece__tzset, file, "");
        newXSproto("Time::Piece::_strptime", XS_Time__Piece__strptime, file, "$$");
    if (PL_unitcheckav)
