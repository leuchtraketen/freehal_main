...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::Normalize::decompose", "src, compat = &PL_sv_no");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	src = ST(0);
	SV *	compat;
#line 459 "Normalize.xs"
    SV* dst;
    U8 *s, *d, *dend;
    STRLEN slen, dlen;
#line 485 "Normalize.c"
	SV *	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::Normalize::reorder", "src");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	src = ST(0);
#line 480 "Normalize.xs"
    SV* dst;
    U8 *s, *d, *dend;
    STRLEN slen, dlen;
#line 528 "Normalize.c"
	SV *	RETVAL;
#line 484 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&slen);
    dst = newSVpvn("", 0);
...
XS(XS_Unicode__Normalize_compose)
{
    ...
    dXSI32;
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", GvNAME(CvGV(cv)), "src");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	src = ST(0);
#line 503 "Normalize.xs"
    SV* dst;
    U8 *s, *d, *dend;
    STRLEN slen, dlen;
#line 566 "Normalize.c"
	SV *	RETVAL;
#line 507 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&slen);
    dst = newSVpvn("", 0);
    dlen = slen + UTF8_MAXLEN;
    d = (U8*)SvGROW(dst,dlen+1);
...
XS(XS_Unicode__Normalize_NFC)
{
    ...
    {
	SV *	src = ST(0);
#line 561 "Normalize.xs"
    SV *dst;
    U8 *s, *t, *tend, *u, *uend, *d, *dend;
    STRLEN slen, tlen, ulen, dlen;
#line 653 "Normalize.c"
	SV *	RETVAL;
#line 565 "Normalize.xs"
    /* decompose */
    s = (U8*)sv_2pvunicode(src,&slen);
    tlen = slen;
    New(0, t, tlen+1, U8);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::Normalize::getCombinClass", "uv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	UV	uv = (UV)SvUV(ST(0));
	U8	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::Normalize::isExclusion", "uv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	UV	uv = (UV)SvUV(ST(0));
	bool	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::Normalize::isSingleton", "uv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	UV	uv = (UV)SvUV(ST(0));
	bool	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::Normalize::isNonStDecomp", "uv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	UV	uv = (UV)SvUV(ST(0));
	bool	RETVAL;
...
XS(XS_Unicode__Normalize_isComp2nd)
{
    ...
    dXSI32;
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", GvNAME(CvGV(cv)), "uv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	UV	uv = (UV)SvUV(ST(0));
	bool	RETVAL;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::Normalize::getComposite", "uv, uv2");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	UV	uv = (UV)SvUV(ST(0));
	UV	uv2 = (UV)SvUV(ST(1));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Unicode::Normalize::splitOnLastStarter", "src");
    PERL_UNUSED_VAR(cv); /* -W */
