...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::TIEHASH", "dbtype, filename, flags, mode");
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::DESTROY", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::FETCH", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	datum_key	key;
...
#endif
    if (items < 3 || items > 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::STORE", "db, key, value, flags = DBM_REPLACE");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	datum_key	key;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::DELETE", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	datum_key	key;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::EXISTS", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	datum_key	key;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::FIRSTKEY", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	datum_key	RETVAL;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::NEXTKEY", "db, key");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	datum_key	key;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::error", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	int	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::clearerr", "db");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	int	RETVAL;
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::filter_fetch_key", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	SV *	code = ST(1);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::filter_store_key", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	SV *	code = ST(1);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::filter_fetch_value", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	SV *	code = ST(1);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "SDBM_File::filter_store_value", "db, code");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SDBM_File	db;
	SV *	code = ST(1);
