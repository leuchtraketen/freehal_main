...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::Cxt::DESTROY", "self");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	self = ST(0);
#line 6371 "Storable.xs"
	stcxt_t *cxt = (stcxt_t *)SvPVX(SvRV(self));
#line 6398 "Storable.c"
#line 6373 "Storable.xs"
	if (kbuf)
		Safefree(kbuf);
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::init_perinterp", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 6406 "Storable.xs"
  init_perinterp(aTHX);
#line 6427 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
XS(XS_Storable_pstore)
{
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::pstore", "f, obj");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	...
	int	RETVAL;
	dXSTARG;
#line 6413 "Storable.xs"
  RETVAL = pstore(aTHX_ f, obj);
#line 6451 "Storable.c"
...
XS(XS_Storable_net_pstore)
{
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::net_pstore", "f, obj");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	OutputStream	f = IoOFP(sv_2io(ST(0)));
	SV *	obj = ST(1);
	int	RETVAL;
	dXSTARG;
#line 6422 "Storable.xs"
  RETVAL = net_pstore(aTHX_ f, obj);
#line 6476 "Storable.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::mstore", "obj");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
	SV *	RETVAL;
#line 6430 "Storable.xs"
  RETVAL = mstore(aTHX_ obj);
#line 6499 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::net_mstore", "obj");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
	SV *	RETVAL;
#line 6438 "Storable.xs"
  RETVAL = net_mstore(aTHX_ obj);
#line 6523 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::pretrieve", "f");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	InputStream	f = IoIFP(sv_2io(ST(0)));
	SV *	RETVAL;
#line 6446 "Storable.xs"
  RETVAL = pretrieve(aTHX_ f);
#line 6547 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::mretrieve", "sv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	sv = ST(0);
	SV *	RETVAL;
#line 6454 "Storable.xs"
  RETVAL = mretrieve(aTHX_ sv);
#line 6571 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::dclone", "sv");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	sv = ST(0);
	SV *	RETVAL;
#line 6462 "Storable.xs"
  RETVAL = dclone(aTHX_ sv);
#line 6595 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::last_op_in_netorder", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	RETVAL;
	dXSTARG;
#line 6469 "Storable.xs"
  RETVAL = last_op_in_netorder(aTHX);
#line 6619 "Storable.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::is_storing", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	RETVAL;
	dXSTARG;
#line 6476 "Storable.xs"
  RETVAL = is_storing(aTHX);
#line 6642 "Storable.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Storable::is_retrieving", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	RETVAL;
	dXSTARG;
#line 6483 "Storable.xs"
  RETVAL = is_retrieving(aTHX);
#line 6665 "Storable.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
