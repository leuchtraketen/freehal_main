...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::_fieldhash", "href, mode");
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::id", "ref");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV*	ref = ST(0);
#line 377 "FieldHash.xs"
    if (SvROK(ref)) {
        XPUSHs(HUF_obj_id(ref));
    } else {
        XPUSHs(ref);
    }
#line 420 "FieldHash.c"
	PUTBACK;
	return;
    }
}
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::id_2obj", "id");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	RETVAL;
	SV*	id = ST(0);
#line 387 "FieldHash.xs"
...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::register", "obj, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	RETVAL;
	SV*	obj = ST(0);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::CLONE", "classname");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	char*	classname = (char *)SvPV_nolen(ST(0));
#line 421 "FieldHash.xs"
    if (0 == strcmp(classname, "Hash::Util::FieldHash")) {
        HUF_global(HUF_CLONE);
        HUF_fix_objects();
    }
#line 512 "FieldHash.c"
    }
    XSRETURN_EMPTY;
}
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::_active_fields", "obj");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV*	obj = ST(0);
#line 429 "FieldHash.xs"
    if (SvROK(obj)) {
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::_test_uvar_get", "svref, countref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV*	svref = ST(0);
	SV*	countref = ST(1);
#line 448 "FieldHash.xs"
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::_test_uvar_set", "svref, countref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV*	svref = ST(0);
	SV*	countref = ST(1);
#line 463 "FieldHash.xs"
    if (SvROK(svref) && SvROK(countref)) {
        counter = SvRV(countref);
        sv_setiv(counter, 0);
        counter = SvRV(countref);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Hash::Util::FieldHash::_test_uvar_same", "svref, countref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV*	svref = ST(0);
	SV*	countref = ST(1);
#line 479 "FieldHash.xs"
    if (SvROK(svref) && SvROK(countref)) {
        counter = SvRV(countref);
        sv_setiv(counter, 0);
        HUF_add_uvar_magic(
...
XS(boot_Hash__Util__FieldHash)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("Hash::Util::FieldHash::_fieldhash", XS_Hash__Util__FieldHash__fieldhash, file, "$$");
        newXSproto("Hash::Util::FieldHash::id", XS_Hash__Util__FieldHash_id, file, "$");
        newXSproto("Hash::Util::FieldHash::id_2obj", XS_Hash__Util__FieldHash_id_2obj, file, "$");
        newXSproto("Hash::Util::FieldHash::register", XS_Hash__Util__FieldHash_register, file, "$@");
        ...
        newXS("Hash::Util::FieldHash::_test_uvar_get", XS_Hash__Util__FieldHash__test_uvar_get, file);
        newXS("Hash::Util::FieldHash::_test_uvar_set", XS_Hash__Util__FieldHash__test_uvar_set, file);
        newXS("Hash::Util::FieldHash::_test_uvar_same", XS_Hash__Util__FieldHash__test_uvar_same, file);

    /* Initialisation Section */

#line 345 "FieldHash.xs"
{
