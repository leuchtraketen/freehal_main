...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::PUSH", "obj, ...");
...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::UNSHIFT", "obj, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
#line 1157 "shared.xs"
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::POP", "obj");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
#line 1180 "shared.xs"
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::SHIFT", "obj");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
#line 1197 "shared.xs"
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::EXTEND", "obj, count");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::STORESIZE", "obj, count");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
	IV	count = (IV)SvIV(ST(1));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::EXISTS", "obj, index");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
	SV *	index = ST(1);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::FIRSTKEY", "obj");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
#line 1254 "shared.xs"
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::tie::NEXTKEY", "obj, oldkey");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
	SV *	oldkey = ST(1);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::_id", "myref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1309 "shared.xs"
        SV *ssv;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::_refcnt", "myref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1325 "shared.xs"
        SV *ssv;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::share", "myref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	myref = ST(0);
#line 1346 "shared.xs"
...
#endif
    if (items < 1 || items > 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::cond_wait", "ref_cond, ref_lock= 0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1360 "shared.xs"
        SV *ssv;
...
#endif
    if (items < 2 || items > 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::cond_timedwait", "ref_cond, abs, ref_lock= 0");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1412 "shared.xs"
        SV *ssv;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::cond_signal", "myref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1467 "shared.xs"
        SV *ssv;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::cond_broadcast", "myref");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1490 "shared.xs"
        SV *ssv;
...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "threads::shared::bless", "myref, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1513 "shared.xs"
        HV* stash;
...
XS(boot_threads__shared)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("threads::shared::_id", XS_threads__shared__id, file, "\\[$@%]");
        newXSproto("threads::shared::_refcnt", XS_threads__shared__refcnt, file, "\\[$@%]");
        newXSproto("threads::shared::share", XS_threads__shared_share, file, "\\[$@%]");
        newXSproto("threads::shared::cond_wait", XS_threads__shared_cond_wait, file, "\\[$@%];\\[$@%]");
        newXSproto("threads::shared::cond_timedwait", XS_threads__shared_cond_timedwait, file, "\\[$@%]$;\\[$@%]");
        newXSproto("threads::shared::cond_signal", XS_threads__shared_cond_signal, file, "\\[$@%]");
        newXSproto("threads::shared::cond_broadcast", XS_threads__shared_cond_broadcast, file, "\\[$@%]");
        newXSproto("threads::shared::bless", XS_threads__shared_bless, file, "$;$");
#endif
