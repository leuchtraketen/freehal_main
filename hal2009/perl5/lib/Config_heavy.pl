...
ccversion=''
cf_by='tobias'
cf_email='tobias@tobias-laptop.nonet'
cf_time='Sun Dec 21 13:26:59 CET 2008'
chgrp=''
chmod='chmod'
chown=''
clocktype='clock_t'
...
libsdirs=' /usr/lib'
libsfiles=' libdl.so libm.so libpthread.so libc.so libcrypt.so'
libsfound=' /usr/lib/libdl.so /usr/lib/libm.so /usr/lib/libpthread.so /usr/lib/libc.so /usr/lib/libcrypt.so'
...
mydomain='.nonet'
myhostname='tobias-laptop'
myuname='linux tobias-laptop 2.6.27-7-generic #1 smp tue nov 4 19:33:06 utc 2008 x86_64 gnulinux '
n='-n'
need_va_copy='define'
...
libs_nolargefiles='-ldl -lm -lpthread -lc -lcrypt'
