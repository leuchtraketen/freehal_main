...
const char* last_ptr_wu  = wu.table_name;
/// wu.table_name = "workunit_prepare";
wu.table_name = "workunit";
...
wu.table_name = last_ptr_wu;

    return 0;
}

const char *BOINC_RCSID_b5f8b10eb5 = "$Id: backend_lib.cpp 20074M 2010-05-22 08:50:12Z (lokal) $";
