...
int init_result(RESULT& result, void*& data) {
    ...
    vector<VALIDATOR_FILE_INFO> files;
    ...
    for (unsigned int i=0; i<files.size(); i++) {
        VALIDATOR_FILE_INFO& fi = files[i];
...
const char *BOINC_RCSID_7ab2b7189c = "$Id: sample_bitwise_validator.cpp 17966M 2012-01-02 16:24:51Z (lokal) $";
