...
extern int get_output_file_info(RESULT& result, VALIDATOR_FILE_INFO&);
extern int get_output_file_infos(RESULT& result, std::vector<VALIDATOR_FILE_INFO>&);
